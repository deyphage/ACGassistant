...
//    private static final int DBversion = 1;
    ...
    private void setupViewComponent() {
        ...
        s_humd = (TextView) findViewById(R.id.humd);
        s_date=(TextView)findViewById(R.id.date);
        s_weather=(TextView)findViewById(R.id.weather);
    ...
    private void dbmysql() {
        ...
        try {
            ...
            if (jsonArray.length() > 0) { // MySQL 連結成功有資料
                ...
                Toast.makeText(Weather.this, "資料庫無資料", Toast.LENGTH_LONG).show();
            }
        }catch (Exception e) {
        }
        cur.close();
