...
public class NewsContentProvider extends ContentProvider {
	private static final String AUTHORITY = "com.hexagonalkun.acgassistant_v3.providers.NewsContentProvider";
	private static final String DB_FILE = "id8606975_acgassistant.db", DB_TABLE = "news";
	...
	private static final String crTBsql = "CREATE TABLE " + DB_TABLE + " ( "
			+ "nwsID INTEGER PRIMARY KEY," + "nwsType TEXT," + "nwsName TEXT,"
			+ "nwsPic TEXT," + "nwsInfo TEXT);";
