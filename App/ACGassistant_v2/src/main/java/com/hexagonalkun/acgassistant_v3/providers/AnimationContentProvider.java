package com.hexagonalkun.acgassistant_v3.providers;
...
public class AnimationContentProvider extends ContentProvider {
	private static final String AUTHORITY = "com.hexagonalkun.acgassistant_v3.providers.AnimationContentProvider";
	private static final String DB_FILE = "id8606975_acgassistant.db", DB_TABLE = "animation";
	...
	private static final String crTBsql = "CREATE TABLE " + DB_TABLE + " ( "
			+ "aniID INTEGER PRIMARY KEY," + "aniType TEXT," + "aniName TEXT,"
			+ "aniPic TEXT," + "aniStartDate TEXT," + "aniEndDate TEXT," + "aniUplaodDay TEXT," + "aniTrailer TEXT," + "aniInfo TEXT);";
