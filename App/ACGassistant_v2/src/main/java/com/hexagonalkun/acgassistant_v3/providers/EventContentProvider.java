...
public class EventContentProvider extends ContentProvider {
	private static final String AUTHORITY = "com.hexagonalkun.acgassistant_v3.providers.EventContentProvider";
	private static final String DB_FILE = "id8606975_acgassistant.db", DB_TABLE = "event";
	...
	private static final String crTBsql = "CREATE TABLE " + DB_TABLE + " ( "
			+ "eveID INTEGER PRIMARY KEY," + "eveType TEXT," + "eveSubType TEXT," + "eveLocationType TEXT,"
			+ "eveName TEXT," + "evePic TEXT," + "eveStartDate TEXT," + "eveEndDate TEXT," + "evelocation TEXT,"
			+ "eveWeb TEXT,"+ "eveMap TEXT,"+ "eveInfo TEXT);";
