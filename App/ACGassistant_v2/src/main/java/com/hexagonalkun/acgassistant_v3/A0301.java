...
public class A0301 extends AppCompatActivity
    ...
    private void setupViewCompoent() {
        listview = (ListView) findViewById(R.id.a0302_list);
//        *********************************************
        ...
        for (int i = 0; i < recSet.size(); i++) {
            ...
            imageResource = getResources().getIdentifier(fld[5],"drawable","com.hexagonalkun.a03");
        ...
        SimpleAdapter adapter = new SimpleAdapter(
                ...
                new String[]{"a0302_imgView", "a0302_txt01", "a0302_txt02", "a0302_txt03", "a0302_txt04", "a0302_txt05","a0302_txt07"},
                new int[]{R.id.a0302_imgView, R.id.a0302_txt01, R.id.a0302_txt02, R.id.a0302_txt03,R.id.a0302_txt04,R.id.a0302_txt05,R.id.a0302_txt07}
        );
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.setClass(A0301.this, A0303.class);
    ...
    private void dbmysql() {
        ...
        try {
            ...
            if (jsonArray.length() > 0) { // MySQL 連結成功有資料
                ...
                Toast.makeText(A0301.this, "主機資料庫無資料", Toast.LENGTH_LONG).show();
            }
            // --------------------------------------------------------
        } catch (Exception e) {
