...
public class WeatherContentProvider extends ContentProvider {
	private static final String AUTHORITY = "com.hexagonalkun.acgassistant_v3.providers.WeatherContentProvider";
	private static final String DB_FILE = "id8606975_acgassistant.db", DB_TABLE = "weather";
	...
	private static final String crTBsql = "CREATE TABLE " + DB_TABLE + " ( "
			+ "ID INTEGER PRIMARY KEY," + "SiteName TEXT," + "Temperature TEXT,"
			+ "Moisture TEXT," + "Weather TEXT," + "DataCreationDate TEXT);";
